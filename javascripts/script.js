...
// ฟังก์ชัน "เปิด"
function showPlayerPages() {
    const modal = document.getElementById('music-modal');
    if (modal) {
        // 1. สั่งให้แสดงผล (เคลียร์ค่า display: none ออก)
        modal.style.display = 'flex'; 
        
        // 2. ใส่ class open เพื่อทำอนิเมชั่น (ถ้ามี)
        modal.classList.add('open');
        
        console.log("เปิดหน้าต่างเพลงแล้ว!");
    }
}
...
function closeMusicPlayer() {
    const modal = document.getElementById('music-modal');
    if (modal) {
        // 1. เอา class open ออก
        modal.classList.remove('open');
        
        // 2. สั่งซ่อนแบบเด็ดขาด
        modal.style.display = 'none';
        
        console.log("ปิดหน้าต่างเพลงแล้ว!");
    }
}
...
let songs = [
    ...
    },
    {
        ...
        album: "Nier saga has one of the most beautiful Soundtrack of the entire history of videogames.",
        albumArtUrl: "https://motionbgs.com/media/761/anime-nier-automata.jpg",
        audioSrc: "audio/dream_ivory_rays_of_light.mp3",
        videoBgSrc: "videos/rays_of_light_bg.mp4", // Path video background khusus lagu ini
        // Lirik dengan timestamp dalam detik
        lyrics: [
            { time: 18.36, text: "The blooming flowers" },
            { time: 80.05, text: "Are also slowly dying away" },
            { time: 86.96, text: "Please, I beg of you" },
            { time: 92.12, text: "Tell me, why must people hurt one another?" },
            { time: 101.09, text: "The petals that fall quietly" },
            { time: 122.63, text: "Are now dancing in the wind" },
            { time: 129.95, text: "Everything is passing by" },
            { time: 134.95, text: "The memories that we once shared" },
            { time: 144.08, text: "Even so" },
            { time: 151.73, text: "I will sing" },
            { time: 158.02, text: "For those who have no name" },
            { time: 160.54, text: "For those who are lost" },
            { time: 164.20, text: "I will continue to sing of peace and love" },
            { time: 230.68, text: "The blooming flowers" },
            { time: 237.77, text: "Are also slowly dying away" },
            { time: 244.92, text: "Please, I beg of you" },
            { time: 250.43, text: "Tell me, why must people hurt one another?" },
            { time: 273.72, text: "The petals that fall quietly" },
            { time: 281.01, text: "Are now dancing in the wind" },
            { time: 288.19, text: "Everything is passing by" },
            { time: 293.31, text: "The memories that we once shared" },
            { time: 302.03, text: "Even so" },
            { time: 310.07, text: "I will sing" },
            { time: 315.55, text: "For those who have no name" },
            { time: 318.73, text: "For those who are lost" },
            { time: 322.22, text: "I will continue to sing of peace and love" }
        ]
    },
    {
        id: 3,
        title: "Sidney - Impostor",
        artist: "Sidney Gish",
        album: "No Dogs Allowed",
        albumArtUrl: "https://images.genius.com/479cd68d944fae314a7e0b0e5a30d043.1000x1000x1.png",
        audioSrc: "audio/sidney_impostor.mp3",
        videoBgSrc: "videos/sidney_impostor_bg.mp4", // Path video background khusus lagu ini
        // Lirik dengan timestamp dalam detik
        lyrics: [
            { time: 46.00, text: "Reboot in suit as I am able" },
            { time: 50.00, text: "Every other day I'm wondering" },
            { time: 54.00, text: "What's the human being got at me like?" },
            { time: 59.00, text: "What's the way to just be competent?" },
            { time: 63.00, text: "These sweet and sexy things for my life" },
            { time: 67.00, text: "Every other day I'm wondering" },
            { time: 71.00, text: "Was it a mistake to try and be fine?" },
            { time: 75.00, text: "What I'm serving's mad in confidence" },
            { time: 79.00, text: "These sweet and sexy things for my life" },
            { time: 83.00, text: "These sweet and sexy things for my life" },
            { time: 113.00, text: "These sweet and sexy things for my life" }
        ]
    }
];
